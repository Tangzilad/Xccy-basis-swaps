...
def render_page() -> None:
    ...
    calc_windows = {
        "friction_adjusted_arbitrage_band": CalculationWindow(
            ...
            f"$({capital_charge_bp}+{funding_spread_bp}+{cva_proxy_bp}+{fva_proxy_bp}+{clearing_friction_bp}+{liquidity_repo_friction_bp})$",
            ("All friction terms are costs.",),
        ...
        "forward_difference": CalculationWindow(
            ...
            ("Positive net edge implies residual arbitrage value.",),
    ...
    render_required_calculation_windows(
        ...
        page_name="5. Persistence / XVA / arbitrage limits",
    )
